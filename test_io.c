...
void principal(void) {
    escribir((CadenaSegura){ .longitud = 28, .datos = "std.io cargada correctamente" });
    escribir((CadenaSegura){ .longitud = 17, .datos = "escribir: escrito" });
    escribir_linea((CadenaSegura){ .longitud = 31, .datos = "escribir_linea: linea con salto" });
    escribir((CadenaSegura){ .longitud = 19, .datos = "escribe tu nombre: " });
    CadenaSegura nombre = leer_linea();
    escribir((CadenaSegura){ .longitud = 6, .datos = "hola, " });
